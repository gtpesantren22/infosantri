                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-sm"
                                                        data-toggle="modal"
                                                        data-target="#exampleModal<?= $r['id_user']; ?>">
                                                        Aksi
                                                    </button>
                                                </td>
                                            </tr>
                                            <!-- Modal -->
                                            <div class="modal fade" id="exampleModal<?= $r['id_user']; ?>" tabindex="-1"
  ...
  if ($sql1) {
    ...
    curl_setopt_array(
      ...
      array(
        ...
        CURLOPT_POSTFIELDS => 'apiKey=f4064efa9d05f66f9be6151ec91ad846&phone=' . $hp . '&message=' . $pesan,
      )
    );
