...
if ($level === 'admin') {
    $sql = mysqli_query($conn, "SELECT * FROM kl_madin ");
} else {
    $sql = mysqli_query($conn, "SELECT * FROM kl_formal WHERE lembaga = '$level'");
}
...
if (isset($_POST['save'])) {
    ...
    $inn2 = mysqli_query($conn, "INSERT INTO kl_madin VALUES ('', '$nmOk', '$tahun') ");
