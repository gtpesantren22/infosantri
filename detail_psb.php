...
$id_sakit = $_GET['id'];
$data = mysqli_fetch_assoc(mysqli_query($psb24, "SELECT * FROM tb_santri WHERE nis = $id_sakit"));
$foto = mysqli_fetch_assoc(mysqli_query($psb24, "SELECT * FROM foto_file WHERE nis = $id_sakit"));

$id_user = $_SESSION['id'];
$dt = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM user WHERE id_user = $id_user "));
$level = $dt['level'];

// $linkFoto = 'https://psb.ppdwk.com/assets/berkas/foto/';
$linkFoto = 'http://localhost/psb/assets/berkas/foto/';
?>
<!DOCTYPE html>
<html lang="en">
